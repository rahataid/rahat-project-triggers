...
describe('ScheduleSourcesDataService', () => {
  ...
  describe('onApplicationBootstrap', () => {
    beforeEach(() => {
      ...
      jest.spyOn(service as any, 'initializeSourceConfigs').mockResolvedValue(undefined);
    });
  ...
  describe('syncRiverWaterData', () => {
    ...
    beforeEach(() => {
      ...
      mockHealthUtilsService.processStationsInParallel.mockResolvedValue(mockResult);
    ...
    it('should sync river water data successfully', async () => {
      ...
      expect(mockDhmStationProcessor.createWaterLevelTasks).toHaveBeenCalledWith(
        mockDataSource[DataSource.DHM],
      );
      expect(mockHealthUtilsService.processStationsInParallel).toHaveBeenCalled();
    ...
    it('should call processWaterLevelStation with correct parameters', async () => {
      ...
      expect(mockDhmStationProcessor.processWaterLevelStation).toHaveBeenCalledWith(
        mockTask.config,
        mockTask.seriesId,
        mockErrors,
      );
    ...
    it('should return early if settings validation fails', async () => {
      ...
      expect(mockDhmStationProcessor.createWaterLevelTasks).not.toHaveBeenCalled();
      expect(mockHealthUtilsService.processStationsInParallel).not.toHaveBeenCalled();
  ...
  describe('syncRainfallData', () => {
    ...
    it('should call processRainfallStation with correct parameters', async () => {
      ...
      expect(mockDhmStationProcessor.processRainfallStation).toHaveBeenCalledWith(
        mockTask.config,
        mockTask.seriesId,
        mockErrors,
      );
    ...
    it('should return early if settings validation fails', async () => {
      ...
      expect(mockDhmStationProcessor.createRainfallTasks).not.toHaveBeenCalled();
      expect(mockHealthUtilsService.processStationsInParallel).not.toHaveBeenCalled();
      expect(mockHealthUtilsService.storeHealthResult).not.toHaveBeenCalled();
    });
  ...
  describe('synchronizeGlofas', () => {
    ...
    it('should call processGlofasStation with correct parameters', async () => {
      ...
      expect(mockGlofasStationProcessor.processGlofasStation).toHaveBeenCalledWith(
        mockGlofasStation,
        mockErrors,
      );
    });
    ...
    it('should return early if settings validation fails', async () => {
      ...
      expect(mockGlofasStationProcessor.createGlofasTasks).not.toHaveBeenCalled();
      expect(mockHealthUtilsService.processStationsInParallel).not.toHaveBeenCalled();
      expect(mockHealthUtilsService.storeHealthResult).not.toHaveBeenCalled();
    });
