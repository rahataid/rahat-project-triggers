...
describe('TriggerHistoryController', () => {
  ...
  describe('create', () => {
    ...
    it('should successfully create trigger history', async () => {
      ...
      expect(mockTriggerHistoryService.create).toHaveBeenCalledWith(
        mockPayload,
      );
  ...
  describe('findAll', () => {
    ...
    it('should successfully find all trigger histories', async () => {
      ...
      expect(mockTriggerHistoryService.findAll).toHaveBeenCalledWith(
        mockPayload,
      );
      expect(result).toEqual(mockResult);
    });
  ...
  describe('getOne', () => {
    ...
    it('should successfully get one trigger history', async () => {
      ...
      expect(mockTriggerHistoryService.getOne).toHaveBeenCalledWith(
        mockPayload,
      );
      expect(result).toEqual(mockResult);
    });
