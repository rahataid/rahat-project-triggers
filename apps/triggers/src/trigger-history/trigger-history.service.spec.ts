...
describe('TriggerHistoryService', () => {
  ...
  describe('create', () => {
    ...
    it('should handle phase cannot be reverted', async () => {
      ...
      mockPrismaService.phase.findUnique.mockResolvedValue(
        mockPhaseCannotRevert,
      );
  ...
  describe('findAll', () => {
    ...
    it('should handle missing phaseUuid', async () => {
      ...
      await expect(service.findAll(invalidPayload as any)).rejects.toThrow(
        RpcException,
      );
    });
  ...
  describe('getCurrentVersionByPhaseId', () => {
    ...
    it('should handle database error', async () => {
      ...
      await expect(service.getCurrentVersionByPhaseId(phaseId)).rejects.toThrow(
        RpcException,
      );
    });
  });
  ...
  describe('getOne', () => {
    ...
    it('should successfully get one trigger history', async () => {
      ...
      mockPrismaService.triggerHistory.findUnique.mockResolvedValue(
        mockTriggerHistory,
      );
