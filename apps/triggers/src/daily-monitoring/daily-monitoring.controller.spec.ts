...
describe('DailyMonitoringController', () => {
  ...
  beforeEach(async () => {
    ...
    controller = module.get<DailyMonitoringController>(
      DailyMonitoringController,
    );
    dailyMonitoringService = module.get<DailyMonitoringService>(
  ...
  describe('add', () => {
    ...
    it('should add daily monitoring data successfully', async () => {
      ...
      expect(mockDailyMonitoringService.create).toHaveBeenCalledWith(
        mockPayload,
      );
  ...
  describe('getAll', () => {
    ...
    it('should get all daily monitoring data successfully', async () => {
      ...
      expect(mockDailyMonitoringService.findAll).toHaveBeenCalledWith(
        mockPayload,
      );
      expect(result).toEqual(mockResult);
    });
    ...
    it('should handle service throwing RpcException', async () => {
      ...
      await expect(controller.getAll(mockPayload)).rejects.toThrow(
        RpcException,
      );
      expect(mockDailyMonitoringService.findAll).toHaveBeenCalledWith(
        mockPayload,
  ...
  describe('getOne', () => {
    ...
    it('should get one daily monitoring data successfully', async () => {
      ...
      expect(mockDailyMonitoringService.findOne).toHaveBeenCalledWith(
        mockPayload,
      );
      expect(result).toEqual(mockResult);
    });
    ...
    it('should handle service throwing RpcException', async () => {
      ...
      await expect(controller.getOne(mockPayload)).rejects.toThrow(
        RpcException,
      );
      expect(mockDailyMonitoringService.findOne).toHaveBeenCalledWith(
        mockPayload,
  ...
  describe('getGaugeForecast', () => {
    ...
    it('should get gauge forecast data successfully', async () => {
      ...
      expect(mockDailyMonitoringService.getGaugeForecast).toHaveBeenCalledWith(
        mockPayload,
      );
      expect(result).toEqual(mockResult);
    });
    ...
    it('should handle service throwing RpcException', async () => {
      ...
      await expect(controller.getGaugeForecast(mockPayload)).rejects.toThrow(
        RpcException,
      );
      expect(mockDailyMonitoringService.getGaugeForecast).toHaveBeenCalledWith(
        mockPayload,
  ...
  describe('update', () => {
    ...
    it('should update daily monitoring data successfully', async () => {
      ...
      expect(mockDailyMonitoringService.update).toHaveBeenCalledWith(
        mockPayload,
      );
      expect(result).toEqual(mockResult);
    });
    ...
    it('should handle service throwing RpcException', async () => {
      ...
      await expect(controller.update(mockPayload)).rejects.toThrow(
        RpcException,
      );
      expect(mockDailyMonitoringService.update).toHaveBeenCalledWith(
        mockPayload,
  ...
  describe('remove', () => {
    ...
    it('should remove daily monitoring data successfully', async () => {
      ...
      expect(mockDailyMonitoringService.remove).toHaveBeenCalledWith(
        mockPayload,
      );
      expect(result).toEqual(mockResult);
    });
    ...
    it('should handle service throwing RpcException', async () => {
      ...
      await expect(controller.remove(mockPayload)).rejects.toThrow(
        RpcException,
      );
      expect(mockDailyMonitoringService.remove).toHaveBeenCalledWith(
        mockPayload,
  ...
  describe('deleteByKeyAndGroup', () => {
    ...
    it('should delete daily monitoring data by key and group successfully', async () => {
      mockDailyMonitoringService.deleteDailyMonitoringByIdAndGroupKey.mockResolvedValue(
        mockResult,
      );
      ...
      expect(
        mockDailyMonitoringService.deleteDailyMonitoringByIdAndGroupKey,
    ...
    it('should handle different payload values', async () => {
      ...
      expect(
        mockDailyMonitoringService.deleteDailyMonitoringByIdAndGroupKey,
      ).toHaveBeenCalledWith(differentPayload);
    });

    it('should handle service throwing RpcException', async () => {
      const error = new RpcException('Service error');
      mockDailyMonitoringService.deleteDailyMonitoringByIdAndGroupKey.mockRejectedValue(
        error,
      );

      await expect(controller.deleteByKeyAndGroup(mockPayload)).rejects.toThrow(
        RpcException,
      );
      expect(
        mockDailyMonitoringService.deleteDailyMonitoringByIdAndGroupKey,
  ...
  describe('Message Pattern Decorators', () => {
    ...
    it('should have correct message pattern commands', () => {
      ...
      expect(
        MS_TRIGGERS_JOBS.DAILY_MONITORING.GET_Gauge_Forecast,
      ).toBeDefined();
  ...
  describe('Dependency Injection', () => {
    it('should have DailyMonitoringService injected', () => {
      ...
      expect(
        dailyMonitoringService.deleteDailyMonitoringByIdAndGroupKey,
      ).toBeDefined();
    });
  });
});
