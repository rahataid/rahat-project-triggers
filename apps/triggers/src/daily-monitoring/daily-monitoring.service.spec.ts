...
describe('DailyMonitoringService', () => {
  ...
  describe('create', () => {
    ...
    it('should throw RpcException when source not found', async () => {
      ...
      await expect(service.create(mockDto)).rejects.toThrow(
        'Failed to create daily monitoring data',
      );
    });

    it('should throw RpcException when database error occurs', async () => {
      mockPrismaService.source.findUnique.mockRejectedValue(
  ...
  describe('findAll', () => {
    ...
    it('should throw RpcException when database error occurs', async () => {
      mockPrismaService.dailyMonitoring.findMany.mockRejectedValue(
        new Error('Database error'),
      );
  ...
  describe('getGaugeForecast', () => {
    ...
    it('should throw RpcException when database error occurs', async () => {
      ...
      await expect(service.getGaugeForecast(mockPayload)).rejects.toThrow(
        RpcException,
      );
    });
  });
  ...
  describe('update', () => {
    ...
    it('should throw RpcException when database error occurs', async () => {
      mockPrismaService.dailyMonitoring.findFirst.mockRejectedValue(
        new Error('Database error'),
      );
  ...
  describe('remove', () => {
    ...
    it('should remove daily monitoring data successfully', async () => {
      mockPrismaService.dailyMonitoring.updateMany.mockResolvedValue({
        count: 2,
      });
    ...
    it('should throw RpcException when database error occurs', async () => {
      mockPrismaService.dailyMonitoring.updateMany.mockRejectedValue(
        new Error('Database error'),
      );
  ...
  describe('deleteDailyMonitoringByIdAndGroupKey', () => {
    ...
    it('should delete daily monitoring data by ID and group key successfully', async () => {
      mockPrismaService.dailyMonitoring.update.mockResolvedValue({
        id: 1,
        isDeleted: true,
      });

      const result =
        await service.deleteDailyMonitoringByIdAndGroupKey(mockPayload);
    ...
    it('should throw RpcException when database error occurs', async () => {
      mockPrismaService.dailyMonitoring.update.mockRejectedValue(
        new Error('Database error'),
      );

      await expect(
        service.deleteDailyMonitoringByIdAndGroupKey(mockPayload),
  ...
  describe('Method Coverage', () => {
    it('should cover all methods in the class', () => {
      ...
      expect(typeof service.deleteDailyMonitoringByIdAndGroupKey).toBe(
        'function',
      );
