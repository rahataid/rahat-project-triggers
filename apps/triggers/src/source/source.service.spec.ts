...
describe('SourceService', () => {
  ...
  describe('findOne', () => {
    ...
    it('should throw RpcException when source not found', async () => {
      ...
      await expect(service.findOne(mockDto)).rejects.toThrow(
        'Source with UUID: test-uuid not found',
      );
    });
    ...
    it('should handle empty UUID', async () => {
      ...
      await expect(service.findOne(emptyDto)).rejects.toThrow(
        'Source with UUID:  not found',
      );
    });
    ...
    it('should handle null UUID', async () => {
      ...
      await expect(service.findOne(nullDto)).rejects.toThrow(
        'Source with UUID: null not found',
      );
    });
    ...
    it('should handle undefined UUID', async () => {
      ...
      await expect(service.findOne(undefinedDto)).rejects.toThrow(
        'Source with UUID: undefined not found',
      );
    });
  });
