...
describe('CategoryController', () => {
  ...
  describe('add', () => {
    ...
    it('should successfully add a category', async () => {
      ...
      expect(mockCategoryService.create).toHaveBeenCalledWith('app-id', {
        name: 'Test Category',
      });
    ...
    it('should handle add without appId in payload', async () => {
      ...
      expect(mockCategoryService.create).toHaveBeenCalledWith(undefined, {
        name: 'Category Without AppId',
      });
      expect(result).toEqual(mockCategory);
    });
  ...
  describe('remove', () => {
    ...
    it('should successfully remove a category', async () => {
      ...
      jest
        .spyOn(mockCategoryService, 'remove')
