...
describe('CategoryService', () => {
  ...
  describe('findAll', () => {
    ...
    it('should successfully find all categories with pagination', async () => {
      ...
      mockPrismaService.activityCategory.findMany.mockResolvedValue(
        mockCategories,
      );
  ...
  describe('findOne', () => {
    ...
    it('should successfully find a category by UUID', async () => {
      ...
      mockPrismaService.activityCategory.findUnique.mockResolvedValue(
        mockCategory,
      );
      ...
      expect(
        mockPrismaService.activityCategory.findUnique,
  ...
  describe('update', () => {
    ...
    it('should successfully update a category', async () => {
      ...
      mockPrismaService.activityCategory.update.mockResolvedValue(
        mockUpdatedCategory,
      );
